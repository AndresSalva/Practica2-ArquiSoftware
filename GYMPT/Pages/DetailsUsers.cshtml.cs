    ...
    public class DetailsUsersModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostCreateAsync()
        {
            try
            {
                if (!ModelState.IsValid)
                {
                    ...
                    TempData["ErrorMessage"] = $"Errores de validación: {errors}";
                ...
                {
                    TempData["ErrorMessage"] = "Los IDs de usuario y membresía deben ser mayores a 0.";
                    return RedirectToPage();
                }
            ...
            {
                // Captura específicamente errores de validación de FK
        ...
        public async Task<IActionResult> OnPostUpdateAsync()
        {
            try
            {
                ...
                {
                    TempData["ErrorMessage"] = "No se encontró el detalle de usuario para actualizar.";
                    return RedirectToPage();
                }
